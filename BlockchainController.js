...
class BlockchainController {
    ...
    // Enpoint to validate a Block chain (GET Endpoint)
    validateChain(){
        this.app.get("/validate/chain", async (req, res) => {
            
            let array = await this.blockchain.validateChain();
            if(array){
    ...
    getBlockByHash() {
        this.app.get("/blocks/:hash", async (req, res) => {
            console.log("REQ "+req.params.hash);
            if(req.params.hash) {
    ...
    getStarsByOwner() {
        this.app.get("/blocks/owner/:address", async (req, res) => {
